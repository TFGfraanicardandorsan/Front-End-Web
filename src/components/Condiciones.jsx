        ...
        <>
            ...
            < Box bg="yellow.200" p={4} m={4} borderRadius="lg" >
                <h1>  <center><font size="6"> <strong>Términos y condiciones</strong></font></center>
                    ...
                    <p>Para utilizar algunos de los servicios de T-Planifica, es posible que necesites estar registrado con tu cuenta y que cuentes con un método de pago válido asociado a dicha cuenta. Si hubiese algún problema para efectuar un cargo en el método de pago que hayas seleccionado, podremos efectuar el cargo en cualquier otro método de pago válido que esté asociado a tu cuenta. <br></br>
